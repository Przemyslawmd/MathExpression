...
class TestParser(TestCase):
    ...
    def test_proper_expression_2(self):
        ...
        self.check_token(tokens[1], TokenType.SYMBOL, 0,  TokenSymbol.BRACKET_LEFT)
        ...
        self.check_token(tokens[5], TokenType.SYMBOL, 0,  TokenSymbol.COSINE)
        self.check_token(tokens[6], TokenType.NUMBER, 30, TokenSymbol.NONE)
        self.check_token(tokens[7], TokenType.SYMBOL, 0,  TokenSymbol.BRACKET_RIGHT)
    ...
    def test_proper_expression_4(self):
        ...
        self.check_token(tokens[2],  TokenType.SYMBOL, 0, TokenSymbol.BRACKET_LEFT)
        ...
        self.check_token(tokens[10], TokenType.SYMBOL, 0, TokenSymbol.BRACKET_RIGHT)
    ...
    def test_proper_expression_5(self):
        ...
        self.check_token(tokens[11], TokenType.SYMBOL, 0,   TokenSymbol.COSINE)
        self.check_token(tokens[12], TokenType.SYMBOL, 0,   TokenSymbol.BRACKET_LEFT)
        ...
        self.check_token(tokens[17], TokenType.SYMBOL, 0,   TokenSymbol.BRACKET_RIGHT)
        self.check_token(tokens[18], TokenType.SYMBOL, 0,   TokenSymbol.BRACKET_RIGHT)
