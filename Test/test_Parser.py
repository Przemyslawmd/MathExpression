...
class TestParser(TestCase):
    ...
    def test_proper_expression_1(self):
        ...
        self.check_token(tokens[1], TokenType.SYMBOL, 0, TokenValue.X)
        self.check_token(tokens[2], TokenType.SYMBOL, 0, TokenValue.PLUS)
    ...
    def test_proper_expression_2(self):
        ...
        self.check_token(tokens[3], TokenType.SYMBOL,       0,  TokenValue.X)
        self.check_token(tokens[4], TokenType.SYMBOL,       0,  TokenValue.PLUS)
    ...
    def test_proper_expression_3(self):
        ...
        self.check_token(tokens[0], TokenType.NUMBER, 3,  TokenValue.NONE)
        self.check_token(tokens[1], TokenType.SYMBOL, 0,  TokenValue.X)
        self.check_token(tokens[2], TokenType.SYMBOL, 0,  TokenValue.POWER)
        self.check_token(tokens[3], TokenType.NUMBER, 3,  TokenValue.NONE)
        self.check_token(tokens[4], TokenType.SYMBOL, 0,  TokenValue.PLUS)
        self.check_token(tokens[5], TokenType.SYMBOL, 0,  TokenValue.LOG)
    ...
    def test_proper_expression_4(self):
        ...
        self.check_token(tokens[1],  TokenType.SYMBOL,  0, TokenValue.DIVISION)
        ...
        self.check_token(tokens[4],  TokenType.SYMBOL,  0, TokenValue.X)
        self.check_token(tokens[5],  TokenType.SYMBOL,  0, TokenValue.PLUS)
        self.check_token(tokens[6],  TokenType.NUMBER,  6, TokenValue.NONE)
        self.check_token(tokens[7],  TokenType.SYMBOL,  0, TokenValue.X)
        self.check_token(tokens[8],  TokenType.SYMBOL,  0, TokenValue.POWER)
    ...
    def test_proper_expression_5(self):
        ...
        self.check_token(tokens[1],  TokenType.SYMBOL,       0,   TokenValue.DIVISION)
        self.check_token(tokens[2],  TokenType.BRACKET,      0,   TokenValue.BRACKET_LEFT)
        self.check_token(tokens[3],  TokenType.SYMBOL,       0,   TokenValue.LOG)
        self.check_token(tokens[4],  TokenType.NUMBER,       350, TokenValue.NONE)
        self.check_token(tokens[5],  TokenType.SYMBOL,       0,   TokenValue.X)
        self.check_token(tokens[6],  TokenType.SYMBOL,       0,   TokenValue.PLUS)
        self.check_token(tokens[7],  TokenType.NUMBER,       55,  TokenValue.NONE)
        self.check_token(tokens[8],  TokenType.SYMBOL,       0,   TokenValue.POWER)
        self.check_token(tokens[9],  TokenType.NUMBER,       2,   TokenValue.NONE)
        self.check_token(tokens[10], TokenType.SYMBOL,       0,   TokenValue.PLUS)
        ...
        self.check_token(tokens[14], TokenType.SYMBOL,       0,   TokenValue.X)
        self.check_token(tokens[15], TokenType.SYMBOL,       0,   TokenValue.PLUS)
