...
class TestParser(TestCase):
    ...
    def test_proper_expression_2(self):
        ...
        self.check_token(tokens[8], 30, TokenValue.NONE)
    ...
    def test_proper_expression_4(self):
        ...
        self.check_token(tokens[2],  0, TokenValue.BRACKET_LEFT)
        self.check_token(tokens[3],  2, TokenValue.NONE)
        self.check_token(tokens[4],  0, TokenValue.MULTIPLICATION)
        self.check_token(tokens[5],  0, TokenValue.X)
        self.check_token(tokens[6],  0, TokenValue.PLUS)
        self.check_token(tokens[7],  6, TokenValue.NONE)
        ...
        self.check_token(tokens[11], 2, TokenValue.NONE)
    ...
    def test_proper_expression_5(self):
        ...
        self.check_token(tokens[4],  350, TokenValue.NONE)
        ...
        self.check_token(tokens[8],  55,  TokenValue.NONE)
        self.check_token(tokens[9],  0,   TokenValue.POWER)
        self.check_token(tokens[10], 2,   TokenValue.NONE)
        ...
        self.check_token(tokens[14], 20,  TokenValue.NONE)
        ...
        self.check_token(tokens[18], 6,   TokenValue.NONE)
    ...
    def test_proper_expression_6(self):
        ...
        self.check_token(tokens[1],  0, TokenValue.MULTIPLICATION)
        self.check_token(tokens[2],  3, TokenValue.NONE)
        self.check_token(tokens[3],  0, TokenValue.PLUS)
        self.check_token(tokens[4],  4, TokenValue.NONE)
        self.check_token(tokens[5],  0, TokenValue.MULTIPLICATION)
        self.check_token(tokens[6],  0, TokenValue.X)
        self.check_token(tokens[7],  0, TokenValue.MULTIPLICATION)
        self.check_token(tokens[8],  0, TokenValue.BRACKET_LEFT)
        self.check_token(tokens[9],  2, TokenValue.NONE)
        ...
        self.check_token(tokens[13], 1, TokenValue.NONE)
    ...
    def test_proper_expression_7(self):
        ...
        self.check_token(tokens[1],  2,  TokenValue.NONE)
        ...
        self.check_token(tokens[7],  0,  TokenValue.MULTIPLICATION)
        self.check_token(tokens[8],  0,  TokenValue.BRACKET_LEFT)
        self.check_token(tokens[9],  12, TokenValue.NONE)
        self.check_token(tokens[10], 0,  TokenValue.MINUS)
        self.check_token(tokens[11], 0,  TokenValue.X)
        self.check_token(tokens[12], 0,  TokenValue.MULTIPLICATION)
        self.check_token(tokens[13], 5,  TokenValue.NONE)
        self.check_token(tokens[14], 0,  TokenValue.BRACKET_RIGHT)
        self.check_token(tokens[15], 0,  TokenValue.MULTIPLICATION)
        self.check_token(tokens[16], 4,  TokenValue.NONE)
    ...
    def test_expression_with_negative_1(self):
        ...
        self.check_token(tokens[3], 3, TokenValue.NONE)
        self.check_token(tokens[4], 0, TokenValue.BRACKET_RIGHT)
        self.check_token(tokens[5], 0, TokenValue.MULTIPLICATION)
        self.check_token(tokens[6], 4, TokenValue.NONE)
    ...
    def test_expression_with_negative_2(self):
        ...
        self.check_token(tokens[7], -5, TokenValue.NONE)
